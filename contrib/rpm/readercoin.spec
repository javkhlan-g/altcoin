...
%{_sbindir}/semanage port -a -t readercoin_port_t -p tcp 9332
%{_sbindir}/semanage port -a -t readercoin_port_t -p tcp 9333
%{_sbindir}/semanage port -a -t readercoin_port_t -p tcp 19332
%{_sbindir}/semanage port -a -t readercoin_port_t -p tcp 19333
