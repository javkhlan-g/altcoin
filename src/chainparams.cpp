...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1555331891, 2442894, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"));
        assert(consensus.hashGenesisBlock == uint256S("00000380ac7c2db0830ff86de876a78cd575e8008d5b5433721ea3090481916d"));
        //assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        assert(genesis.hashMerkleRoot == uint256S("6bc2585d63185acf3868cc34e0b017b3fb41c00938eb09bc52a3cf73a31ec6a8"));
        ...
        chainTxData = ChainTxData{
            ...
            1555331891, // * UNIX timestamp of last known number of transactions
